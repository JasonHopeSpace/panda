...
use halo2mniddleware::halo2curves::bn256::{Fr as Scalar, G1Affine as Point};
use halo2mniddleware::halo2curves::ff::Field;
use halo2mniddleware::halo2curves::msm::best_multiexp;
use halo2mniddleware::halo2curves::zal::MsmAccel;
...
fn msm(c: &mut Criterion) {
    ...
    for k in SIZES {
        ...
        group
            .bench_function(BenchmarkId::new("panda", k), |b| {
                assert!(k < 64);
                let n: usize = 1 << k;
                b.iter(|| {
